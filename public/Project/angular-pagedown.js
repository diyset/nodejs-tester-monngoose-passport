        ...
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                var newElement = $compile(
                    ...
                    '</textarea>' +
                    '</div>' +
                    '<b>Hasil Preview :</b><div id="wmd-preview-' + editorUniqueId + '" style="' + previewHiddenStyle + '"' +
                    ' ' + (scope.previewClass ? 'ng-class="previewClass"' : 'class="wmd-panel wmd-preview col-md-6"') + '>' +
                    '</div>' +
                    '</div>')(scope);
                ...
                //         templateUrl: "public/Project/modal.html",
